...
export default function Wheel({ wheelItems, wheelOffset, theme }) {
    return (
        <div className="wheel-container" style={{ border: `1px solid ${COLORS.border[theme]}`, background: COLORS.card[theme] }}>
            <div style={{ position: "absolute", top: "50%", left: 0, right: 0, transform: "translateY(-50%)", height: "80px", background: theme === "dark" ? "rgba(232,93,38,0.08)" : "rgba(232,93,38,0.05)", borderTop: `1px solid ${COLORS.accent}22`, borderBottom: `1px solid ${COLORS.accent}22`, zIndex: 2, pointerEvents: "none" }} />
